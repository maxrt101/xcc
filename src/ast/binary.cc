...
static const binop::List s_binops = {
  ...
  XCC_BINOP(TOKEN_GREATER_EQUALS, INTEGER | SIGNED,   CreateICmpSGE,     "gecmpstmp",   ()                ),
  XCC_BINOP(TOKEN_GREATER_EQUALS, INTEGER | UNSIGNED, CreateICmpUGE,     "gecmputmp",   ()                ),
  XCC_BINOP(TOKEN_GREATER_EQUALS, FLOAT,              CreateFCmpUGE,     "gecmpftmp",   (llvm::MDNode *)  ),
  XCC_BINOP(TOKEN_GREATER,        INTEGER | SIGNED,   CreateICmpSGT,     "gtcmpstmp",   ()                ),
  XCC_BINOP(TOKEN_GREATER,        INTEGER | UNSIGNED, CreateICmpUGT,     "gtcmputmp",   ()                ),
  XCC_BINOP(TOKEN_GREATER,        FLOAT,              CreateFCmpUGT,     "gtcmpftmp",   (llvm::MDNode *)  ),
  XCC_BINOP(TOKEN_LESS_EQUALS,    INTEGER | SIGNED,   CreateICmpSLE,     "lecmpstmp",   ()                ),
  XCC_BINOP(TOKEN_LESS_EQUALS,    INTEGER | UNSIGNED, CreateICmpULE,     "lecmputmp",   ()                ),
  XCC_BINOP(TOKEN_LESS_EQUALS,    FLOAT,              CreateFCmpULE,     "lecmpftmp",   (llvm::MDNode *)  ),
  XCC_BINOP(TOKEN_LESS,           INTEGER | SIGNED,   CreateICmpSLT,     "ltcmpstmp",   ()                ),
  XCC_BINOP(TOKEN_LESS,           INTEGER | UNSIGNED, CreateICmpULT,     "ltcmputmp",   ()                ),
  ...
  XCC_BINOP(TOKEN_PERCENT,        INTEGER | UNSIGNED, CreateURem,        "uremtmp",     ()                ),
};
