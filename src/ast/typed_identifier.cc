...
TypedIdentifier::TypedIdentifier(std::shared_ptr<Identifier> name, std::shared_ptr<Node> type, std::shared_ptr<Node> value)
  : Node(AST_EXPR_TYPED_IDENTIFIER), name(std::move(name)), value_type(std::move(type)), value(std::move(value)) {}

std::shared_ptr<TypedIdentifier> TypedIdentifier::create(std::shared_ptr<Identifier> name, std::shared_ptr<Node> type, std::shared_ptr<Node> value) {
