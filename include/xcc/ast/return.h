...
public:
  explicit Return(SourceSpan span, LexicalScope scope, std::shared_ptr<Node> value = nullptr);
  ~Return() override = default;

  static std::shared_ptr<Return> create(SourceSpan span, LexicalScope scope, std::shared_ptr<Node> value = nullptr);
