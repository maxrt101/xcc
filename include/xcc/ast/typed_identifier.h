...
public:
  TypedIdentifier(SourceSpan span, LexicalScope scope, std::shared_ptr<Identifier> name, std::shared_ptr<Node> type, std::shared_ptr<Node> value = nullptr);
  ~TypedIdentifier() override = default;

  static std::shared_ptr<TypedIdentifier> create(SourceSpan span, LexicalScope scope, std::shared_ptr<Identifier> name, std::shared_ptr<Node> type, std::shared_ptr<Node> value = nullptr);
