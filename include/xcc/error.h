...
enum ErrorId {
  ...
  ERROR_INLINE_ATTR_INVALID_VALUE                  = 107,
  ERROR_NO_SUCH_LOCAL_VARIABLE                     = 108,
  ERROR_ENV_VAR_MISSING_DEFAULT                    = 109,
  ERROR_INIT_EXPECTED_NAMED_VALUE                  = 110,
  ERROR_BLOCK_MISSING_SEMICOLON                    = 111,
  ERROR_INIT_MISSING_OPENING_BRACE                 = 112,
  ...
  ERROR_NOT_ASM_IN_NAKED_FN                        = 120,
  ERROR_TUPLE_MISSING_CLOSING_SQUARE_BRACE         = 121,
  ERROR_TUPLE_MISSING_FIELDS                       = 122,
  ERROR_DECOMPOSITION_EXPECTED_IDENTIFIER          = 123,
  ERROR_DECOMPOSITION_BAD_WILDCARD                 = 124,
  ERROR_DECOMPOSITION_BAD_TYPE                     = 125,
  ERROR_DECOMPOSITION_MISSING_OPENING_SQUARE_BRACE = 126,
  ...
  ERROR_LAMBDA_MISSING_KEYWORD                     = 148,
  ERROR_LAMBDA_MISSING_OPENING_SQUARE_BRACE        = 149,
  ERROR_LAMBDA_MISSING_CLOSING_SQUARE_BRACE        = 150,
  ERROR_LAMBDA_MISSING_OPENING_PAREN               = 151,
  ERROR_LAMBDA_MISSING_CLOSING_PAREN               = 152,
  ERROR_LAMBDA_MISSING_BODY                        = 153,
  ERROR_LAMBDA_TYPE_MISSING_CLOSING_SQUARE_BRACE   = 154,
...
enum WarningId {
  ...
  WARNING_USE_AFTER_MOVE    = 3,
  WARNING_UNINITIALIZED_USE = 4,
